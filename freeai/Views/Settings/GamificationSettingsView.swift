...
struct GamificationSettingsView: View {
    ...
    var body: some View {
        Form {
            Section(header: Text("XP System"), footer: Text("Earn XP for interacting with Neural AI. Level up for fun! Actions like chatting, completing reminders, saving notes, and generating digests award XP.")) {
